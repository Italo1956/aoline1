...
async function cargarDatos() {
    try {
        ...
        let datosOrdenados = [...productosOriginales];

        switch (ordenar) {

            case 'indiceAsc':
                datosOrdenados.sort((a, b) => a.indiceOriginal - b.indiceOriginal);
                break;

            case 'indiceDesc':
                datosOrdenados.sort((a, b) => b.indiceOriginal - a.indiceOriginal);
                break;
            ...
            productCard.innerHTML = `
                ...
                <div class="images">
                    <div class="left">
                        ...
                        <div title="Beneficio Neto">NETO: $${((producto.price)*(producto.roi)).toFixed([2])} </div>
                    </div>
                    <div class="right">
